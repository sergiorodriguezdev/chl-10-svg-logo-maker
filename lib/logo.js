...
class Logo {
    ...
    constructor(text, textColor, textColorHex, shape, shapeColor, shapeColorHex) {
        ...
        // Instantiate the correct type of shape object based on the shape argument
        if(shape === 'circle') {
        ...
        // I will use this to save the logo to a file
        this.fileName = `logo-${this.text}-${shape}.svg`;
    }
